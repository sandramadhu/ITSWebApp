/* 
 * $Id: calendar-setup.js,v 1.1 2009-02-16 15:18:43 Savita.Kamble Exp $
...
Zapatec.Calendar.setup = function (params) {
	...
	function onSelect(cal) {
		...
		if(typeof hideDropDowns != "undefined" && hideDropDowns)
			toggleDropDownsOfHs('visible');
	};
	...
	triggerEl["on" + params.eventName] = function() {
		...
		if (!params.position){
			cal.showAtElement(params.button || params.displayArea || params.inputField, params.align);
				...
				if(typeof calX != "undefined")
					calX = params.position[0];
				if(typeof calY != "undefined")
					calY = params.position[1];
			}
		if(typeof hideDropDowns != "undefined" && hideDropDowns)
			toggleDropDownsOfHs('hidden');
		return false;
	};
