...
public class DeviceHistoryTask {
	...
	public void process() throws IOException {
		...
		try{
			System.out.println("$$$ DeviceHistoryTask Log Batch started at " + new Date());
	...
	//		InputStream in = new FileInputStream("classpath:batchjobs.properties");
			...
			File file = new File(props.getProperty("devicehistory.dir"));
			...
			System.out.println("$$$ DeviceHistoryTask Log Batch ended at " + new Date());
		}
		catch(Exception e){
			e.printStackTrace();
		}
