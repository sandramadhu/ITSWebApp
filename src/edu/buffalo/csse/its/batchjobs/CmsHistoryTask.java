...
public class CmsHistoryTask {
	...
	public void process() throws IOException {
		...
		try{
			System.out.println("$$$ CmsHistoryTask Log Batch started at " + new Date());
	...
	//		InputStream in = new FileInputStream("classpath:batchjobs.properties");
			...
			File file = new File(props.getProperty("cmshistory.dir"));
//			System.out.println("test123..bcdeventhistory.");
			...
			System.out.println("$$$ CmsHistoryTask Log Batch ended at " + new Date());
		}
		catch(Exception e){
			e.printStackTrace();
		}
