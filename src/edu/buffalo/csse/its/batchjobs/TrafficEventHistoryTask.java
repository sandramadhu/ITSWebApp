...
public class TrafficEventHistoryTask {
	...
	public void process() throws IOException {
		...
		try{
			System.out.println("$$$ TrafficEventHistoryTask Log Batch started at " + new Date());
	...
	//		InputStream in = new FileInputStream("classpath:batchjobs.properties");
			...
			File file = new File(props.getProperty("trafficeventhistory.dir"));
			...
			System.out.println("$$$ TrafficEventHistoryTask Log Batch ended at " + new Date());
		}
		catch(Exception e){
			e.printStackTrace();
		}
