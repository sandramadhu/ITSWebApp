...
public class ExternalAgencyHistoryTask {
	...
	public void process() throws IOException {
		...
		try{
			System.out.println("$$$ ExternalAgencyHistoryTask Log Batch started at " + new Date());
	...
	//		InputStream in = new FileInputStream("classpath:batchjobs.properties");
			...
			File file = new File(props.getProperty("externalagencyhistory.dir"));
			...
			System.out.println("$$$ ExternalAgencyHistoryTask Log Batch ended at " + new Date());
		}
		catch(Exception e){
			e.printStackTrace();
		}
